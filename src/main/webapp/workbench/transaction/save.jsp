...
<body>
	...
	<form action="workbench/transaction/save" id="tranForm" method="post" class="form-horizontal" role="form"  style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc"value="发传单23">
				<input type="hidden" name="activityid" value="2d5af60d72964f3fb83dc540abb91006">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-contactsName"value="ywees">
				<input type="hidden" name="contactsid" value="3cf63352a1544b6fb450dc7dece7cbb0">
			</div>
		</div>
